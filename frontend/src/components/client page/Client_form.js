...
function Client_form() {
  ...
  <div className="col-md-12">
    ...
    <form className="form-horizontal" method="POST" action="/users/add/" id="add_new_user_form" onSubmit={handlesubmit}>
      ...
      <div className="form-group row">
        <label for="billing" name='Billing' className="col-md-3 control-label">Billing </label>
      ...
      <div className="form-group row">
        ...
        <div className="col-md-10" style={{maxWidth:'450px'}}>
          <textarea className="form-control" id="description" rows={3}  name="description" onChange={handleform}/>
        </div>
      </div>

      <div className="form-group row">
        <label for="billingaddress" className="col-md-3 control-label" >Billing Address</label>
        <div className="col-md-10" style={{maxWidth:'450px'}}>
          <textarea className="form-control" id="billingaddress" rows={3}  name="billingaddress" onChange={handleform}/>
        </div>
      </div>
